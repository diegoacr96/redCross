...
import { Button, Select, Icon, Input, Header, swiche } from "../components/";
...
/* class Elements extends React.Component {
  ...
  toggleswiche = swicheId =>
    this.setState({ [swicheId]: !this.state[swicheId] });
    ...
    return (
      <Block flex style={styles.group}>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          ...
          >
            <Text size={14}>swiche is ON</Text>
            <swiche
              value={this.state["swiche-1"]}
              onValueChange={() => this.toggleswiche("swiche-1")}
            />
          </Block>
          <Block row middle space="between">
            <Text size={14}>swiche is OFF</Text>
            <swiche
              value={this.state["swiche-2"]}
              onValueChange={() => this.toggleswiche("swiche-2")}
            />
          </Block>
        </Block>
      </Block>
...
const Elements = (props) => {
  ...
  const [swiche, setSwiche] = useState({
    'swiche-1': true,
    'swiche-2': false
  })

  const toggleswiche = swicheId =>
    setswiche({
      ...swiche,
      [swicheId]: !swiche[swicheId]
    })
      ...
      <Block flex style={styles.group}>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          ...
          >
            <Text size={14}>swiche is ON</Text>
            <swiche
              value={state["swiche-1"]}
              onValueChange={() => toggleswiche("swiche-1")}
            />
          </Block>
          <Block row middle space="between">
            <Text size={14}>swiche is OFF</Text>
            <swiche
              value={state["swiche-2"]}
              onValueChange={() => toggleswiche("swiche-2")}
            />
          </Block>
        </Block>
      </Block>
    ...
    return (
      <Block flex style={styles.group}>
        ...
        <Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header white back title="Title" navigation={props.navigation} bgColor={argonTheme.COLORS.ACTIVE} titleColor="white" iconColor="white" />
          </Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header tabs={tabs.categories} search title="Title" navigation={props.navigation} />
          </Block>
